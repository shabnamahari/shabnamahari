 ...
 * and MENU landed on top of it. So below md they are one fixed flex row, which
 * cannot overlap by construction, on Paper, the brand guide's colour for sticky
 * headers (p.9), so the page does not show through while scrolling.
 *
...
export default function Header({
  ...
  return (
    ...
    <header
      className={`pointer-events-none fixed inset-x-0 top-0 z-[999999999] flex items-center gap-3 px-4 py-3 md:absolute md:z-auto md:block md:p-4 ${
        isMenuOpen
          ? ""
